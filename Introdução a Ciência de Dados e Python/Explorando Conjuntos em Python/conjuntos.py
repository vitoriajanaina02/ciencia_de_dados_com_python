...
#
# Criando Sets
# Um set é uma coleção que não possui objetos repetidos, usamos sets
# para representar conjuntos matemáticos ou eliminar itens duplicados
# de um iterável.
#
# Exemplo
...
# queira acessar os seus valores é necessário converter o conjunto
# para lista.
#
# Exemplo
numeros = {1, 2, 3, 4}
