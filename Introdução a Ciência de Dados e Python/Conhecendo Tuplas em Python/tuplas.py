...
# diferença é que tuplas são imutáveis enquanto listas são mutáveis. Podemos
# criar tuplas através da classe tuple, ou colocando valores separados por 
# vírgula de parenteses.
#
# Exemplo
...
# Acesso Direto
#
# A tupla é uma sequência, portanto podemos acessar seus dados utlizando
# índices. Contamos o índice de determinada sequência a partir do zero.
#
# Exemplo
...
# Iterar Tuplas
#
# A forma mais comum para percorrer os dados de uma tupla é utilizando o comandor for.
#
# Exemplo
